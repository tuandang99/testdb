...
/**
 * Standalone Server for Database Management Application
 *
 * Một server độc lập để chạy ứng dụng mà không cần Vite.
 * Server này chỉ cung cấp các API cơ bản và các tài nguyên tĩnh.
 *
 * Sử dụng:
